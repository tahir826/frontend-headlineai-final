...
>
  <div className="flex flex-col items-center">
    <p className="text-5xl sm:text-6xl md:text-8xl mt-10 bg-gradient-to-r from-blue-500 to-purple-700 bg-clip-text text-transparent font-bold leading-tight">
      HeadlineAI
    </p>
  ...
  <div className="mt-6">
    <p className="text-white text-lg sm:text-2xl md:text-7xl leading-relaxed mt-10">
